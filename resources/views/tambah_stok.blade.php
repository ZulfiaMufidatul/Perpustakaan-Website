    ...
    <form action="/stok/store" method="post">
        ...
        <table>
            <tr>
                ...
                <td>:</td>
                <td><input type="text" name="id_stok" required="required" placeholder="Masukkan"></td>
            </tr>
            <tr>
                <td><strong>Id Buku</strong></td>
                <td>:</td>
                <td><input type="text" name="id_buku" required="required" placeholder="Masukkan "></td>
            </tr>
            <tr>
                <td><strong>Jumlah Stok</strong></td>
                <td>:</td>
                <td><input class="kelas" type="text" name="jml_stok" required="required" placeholder="Masukkan "></td>
            </tr>
